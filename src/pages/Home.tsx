...
export default function Home() {
  ...
  return <main>
    ...
    <section className="hero hero-minimal" id="top"><div className="hero-copy"><p className="eyebrow">ATELIER TEE / ESSENTIALS</p><h1>Everyday T-shirts,<br /><span>done properly.</span></h1><p className="hero-intro">Premium-weight cotton. Refined fits. Small batches made to stay in your weekly rotation.</p><div className="hero-actions"><a className="button button-light" href="#shop">Shop collection <ArrowRight size={17} /></a><span>10 considered styles · live stock</span></div></div><div className="hero-side-note"><span>01</span><p>Built around fewer<br />better basics.</p></div></section>
