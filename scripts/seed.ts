...
const products = [
  ['Ivory T-Shirt', 'A heavyweight 260gsm cotton T-shirt with a clean, relaxed drape.', 'https://images.jackjones.com/12191190/3644544/003/jackjones-paquetede5camisetalisocuelloredondo-azul.jpg?crop=1.91%3A1&quality=90&v=2148e5cab58d8b7070c5e939bae8141e&width=1200', 4800, 1],
  ...
  ['Black T-Shirt', 'Structured heavyweight cotton with a refined rib collar.', 'https://media.falabella.com/falabellaCL/127728373_03/w%3D1500%2Ch%3D1500%2Cfit%3Dcover', 5600, 5],
  ...
  ['White T-Shirt', 'Crisp organic cotton with a relaxed, boxy cut.', 'https://images.jackjones.com/12156101/3218229/003/jackjones-jjeorganicbasicteesso-necknoos-beige.jpg?crop=1.91%3A1&quality=90&v=ccc71d631a1c9531bcdf37877a6f48fe&width=1200', 4600, 2],
  ['Moss Green T-Shirt', 'Dense cotton jersey with a soft-washed finish.', 'https://media.falabella.com/falabellaCL/127728373_03/w%3D1500%2Ch%3D1500%2Cfit%3Dcover', 5800, 4],
  ...
  ['Graphite T-Shirt', 'A fluid, longline T-shirt in substantial graphite cotton jersey.', 'https://media.falabella.com/falabellaCL/127728373_03/w%3D1500%2Ch%3D1500%2Cfit%3Dcover', 6000, 2],
].map(([name, description, imageUrl, priceCents, stock], index) => ({ name: String(name), description: String(description), imageUrl: index % 3 === 1 || index === 2 || index === 5 || index === 9 ? blackHanger : whiteHanger, priceCents: Number(priceCents), currency: 'usd' as const, totalStock: Number(stock), availableStock: Number(stock), version: 0 }))
